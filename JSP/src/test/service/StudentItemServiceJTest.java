...
//	}
	...
	void test_1_9() {
		...
		Pagination pagination = studentItemService.getPagination(180, 5);

		assertEquals(pagination.getCurrentPage(), 180);
		assertEquals(pagination.getPpre(), 1);
		assertEquals(pagination.getPre(), 161);
		assertEquals(pagination.getStartPage(), 171);
		assertEquals(pagination.getEndPage(), 190);
		assertEquals(pagination.getNext(), 191);
		assertEquals(pagination.getNnext(), 191);
	}
